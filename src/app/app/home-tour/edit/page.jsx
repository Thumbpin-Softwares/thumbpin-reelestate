...
export default function HomeTourEditPage() {
  ...
  useEffect(() => {
    try {
      const raw = sessionStorage.getItem("home_tour_composition");
      if (raw) {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      const res = await fetch("/api/home-tour/render-remotion", {
        method: "POST",
      ...
      const downloadUrl = `${data.url}${sep}download=1&filename=home-tour.mp4`;

      const a = document.createElement("a");
      a.href = downloadUrl;
      a.download = "home-tour.mp4";
  ...
  if (!compositionProps) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4">
        ...
        <Button variant="ghost" size="sm" onClick={() => router.push("/app/home-tour")}>
  ...
  return (
    <div className="max-w-6xl mx-auto py-8 px-4">
      ...
      <div className="flex items-center gap-3 mb-8">
        <Button variant="ghost" size="sm" onClick={() => router.push("/app/home-tour")} className="gap-2">
