 ...
 *
 * Forked from seedance-reel/StepScript:
 * - Adds a pronunciation-preview button next to the script textarea itself,
 *   distinct from the existing per-voice sample preview — this one synthesizes
 *   the user's ACTUAL typed text so they can catch mispronunciations and edit
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex gap-1.5">
              ...
              <button
                ...
                title="Preview this voice (sample sentence)"
      ...
      {isScriptReady && (
        <div className="rounded-xl border border-[#c7f038]/30 bg-[#c7f038]/5 p-3 flex gap-2">
          ...
          <p className="text-[11px] text-neutral-700 leading-relaxed">
            <strong>Action Reel pipeline:</strong> The script will be split into 2 parts — Part 1 (hook) and Part 2 (highlights + CTA), each rendered as its own full ~15s high-energy Seedance scene with your dialogue baked in.
          </p>
        </div>
      )}
