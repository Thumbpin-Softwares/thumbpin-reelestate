 ...
 *
 * Forked from action-reel/StepScript — same pronunciation-preview mechanics,
 * pointed at /api/comedy-reel/preview-script instead.
 */
export function StepScript({ onBack, onGenerate }) {
  ...
  const handlePreviewScript = async () => {
    ...
    try {
      const res = await fetch("/api/comedy-reel/preview-script", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
